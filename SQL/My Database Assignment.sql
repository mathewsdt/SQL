CREATE TABLE Blockbuster_branch (
	Blockbuster_BranchID INT PRIMARY KEY NOT NULL IDENTITY (1,1),
	Blockbuster_BranchName varchar(50) NOT NULL,
	BlockBuster_BranchAddress varchar(50) NOT NULL
);

INSERT INTO Blockbuster_branch (Blockbuster_BranchName, Blockbuster_BranchAddress)
VALUES ('Fairview', '187 Fair Ave.'),
('Castlerock', '123 Castlepine St.'),
('Littleton', '126   St.'),
('Denver', '716 Break Rd.')
;
SELECT * FROM Blockbuster_branch;
...
VALUES ('Dom Mathews', 'Littleton', '720-579-6647'),
